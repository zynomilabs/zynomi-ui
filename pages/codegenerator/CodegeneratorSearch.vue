<template>
    <div>
        <form name="frmSearchCodegenerator" id="frmSearchCodegenerator" ref="frmSearchCodegenerator" v-on:submit.prevent
            class="space-y-8 divide-y divide-gray-200">
            <div v-if="isFilterCodegeneratorVisible" class="px-2 pt-2 border-b space-y-2">
                ...
                <div class="py-3 text-right">
                    ...
                    <button @click="searchCodegenerator()" type="submit"
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                isFilterCodegeneratorVisible: false,
                mark_as_delete: "",
        }
    },
    methods: {
        searchCodegenerator() {
            ...
            $nuxt.$emit('evtSearchCodegenerator', args)
        },
    ...
    created() {
        this.$nuxt.$on('evtFilterCodegenerator', (data) => {
            this.isFilterCodegeneratorVisible = !this.isFilterCodegeneratorVisible;
        });
    },
};
</script>