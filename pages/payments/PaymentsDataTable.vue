				...
				<div class="flex-1 m-1 p-1">
					...
					>
						...
						<v2-table-column label="Status" prop="payment_status" width="100">
							<template slot-scope="scope">
								<span
									...
									:class="scope.row.payment_status=='Complete' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'"
								>
						...
						<v2-table-column label="" prop="" width="30">
							<template slot-scope="scope">
								<button
									@click="$nuxt.$emit('evtUpsertPayments',scope.row)"
						...
						<v2-table-column label="" prop="" width="30">
							<template slot-scope="scope">
								<button
									...
									@click="$nuxt.$emit('evtDeletePayments',scope.row)"
									class="inline-flex space-x-2 text-gray-400 hover:text-gray-500"
								>
									<svg
										xmlns="http://www.w3.org/2000/svg"
