                        ...
                        <div class="bg-white space-y-6">
                          <div class="grid grid-cols-1 gap-y-3 gap-x-4 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-6">
                              ...
                              <div class="mt-1 rounded-md shadow-sm">
                                <input v-model="data.firstname" type="text" id="firstname" name="firstname" autocomplete="firstname" class="flex-1 focus:ring-green-500 focus:border-green-500 block w-full min-w-0 sm:text-sm border-gray-300" />
                              </div>
                            </div>
                            ...
                            <div class="sm:col-span-6">
                              ...
                              <div class="mt-1 rounded-md shadow-sm">
                                <input v-model="data.lastname" type="text" id="lastname" name="lastname" autocomplete="lastname" class="flex-1 focus:ring-green-500 focus:border-green-500 block w-full min-w-0 sm:text-sm border-gray-300" />
                              </div>
                            </div>
                            <div class="sm:col-span-6">
                              <label for="name" class="block text-sm font-medium text-gray-700"> Username </label>
                              <div class="mt-1 rounded-md shadow-sm">
                                <input v-model="data.login" type="text" id="login" name="login" autocomplete="login" class="flex-1 focus:ring-green-500 focus:border-green-500 block w-full min-w-0 sm:text-sm border-gray-300" />
                              </div>
                            </div>
...
export default {
  ...
  mounted() {},
  created() {
    this.$nuxt.$on('evtUpsertUsers', (data) => {
      if (data !== undefined) {
        this.data = data;
        this.isUpsertUsersVisible = !this.isUpsertUsersVisible;
        return this.data;
    ...
    this.$nuxt.$on('evtDeleteUsers', (data) => {
      if (data !== undefined) {
        this.data = data;
        this.deleteUsers();
      }
  ...
  beforeDestroy() {
    this.$nuxt.$off('evtUpsertUsers');
    this.$nuxt.$off('evtDeleteUsers');
  },
};
</script>
