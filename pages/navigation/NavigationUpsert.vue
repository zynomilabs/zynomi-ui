<template>
    <section v-if="isUpsertNavigationVisible" class="fixed inset-0 overflow-hidden" aria-labelledby="slide-over-title"
                ...
                <div class="w-screen max-w-md">
                    <div class="h-full divide-y divide-gray-200 flex flex-col bg-white shadow-xl">
                            ...
                            <header class="space-y-1 py-6 px-4 bg-green-700 sm:px-6">
                                <div class="flex items-center justify-between space-x-3">
                                    ...
                                    <div class="h-7 flex items-center">
                                        <button v-on:click="closeNavigationPanel()" aria-label="Close panel"
                                ...
                                <div>
                                    <p class="text-sm leading-5 text-green-300">
                                        Create or update Navigation record
                                    </p>
                                </div>
                            </header>
                            <div class="flex-1 flex flex-col justify-between">
                                <div class="px-4 divide-y divide-gray-200 sm:px-6">
                                    <div class="space-y-6 pt-6 pb-5">
                                        <form name="frmNavigation" id="frmNavigation"
                                                ...
                                                <div class="bg-white space-y-6">
                                                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                                        ...
                                                        <div class="sm:col-span-6">
                                                            ...
                                                            <div class="mt-1 rounded-md shadow-sm">
                                                                <input v-model="data.parent_code" type="text" id="parent_code"
                                                                    name="parent_code" autocomplete="parent_code"
                                                        ...
                                                        <div class="sm:col-span-6">
                                                            ...
                                                            <div class="mt-1 rounded-md shadow-sm">
                                                                <input v-model="data.icon" type="text" id="icon"
                                                                    name="icon" autocomplete="icon"
                                                                    class="flex-1 focus:ring-green-500 focus:border-green-500 block w-full min-w-0 sm:text-sm border-gray-300">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="sm:col-span-6">
                                                            ...
                                                            <div class="mt-1 rounded-md shadow-sm">
                                                                <input v-model="data.link" type="text" id="link"
                        ...
                        <div class="w-full flex-shrink-0 px-4 py-4 space-x-4 flex justify-end">
                            ...
                            <span class="inline-flex rounded-md shadow-sm">
                                <button v-on:click="upsertNavigation" type="submit"
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                isUpsertNavigationVisible: false,
                data: { },
                api: ""
        }
    },
    methods: {
        async upsertNavigation(args) {
            try {
                if (this.$_.isUndefined(this.data.id)) {
                    const {
                        data
                    } = await this.$axios.post(this.$config.apiURL + "Navigation", this.data);
                } else {
                    const {
                        data
                    } = await this.$axios.put(this.$config.apiURL + "Navigation/" + this.data.id, this.data);
                }
                this.data = {}
                this.isUpsertNavigationVisible = !this.isUpsertNavigationVisible;
                $nuxt.$emit('evtRefreshNavigationDatatable')
        ...
        async deleteNavigation() {
            try {
                ...
                const {
                    data
                } = await this.$axios.delete(this.$config.apiURL + "Navigation/" + this.data.id);
                $nuxt.$emit('evtRefreshNavigationDatatable')
    ...
    created() {
        this.$nuxt.$on('evtUpsertNavigation', (data) => {
            if (data !== undefined) {
                this.data = data;
                this.isUpsertNavigationVisible = !this.isUpsertNavigationVisible;
                return this.data;
        ...
        //2) Delete Navigation record and then rebind datatable
        this.$nuxt.$on('evtDeleteNavigation', (data) => {
            if (data !== undefined) {
                this.data = data;
    ...
    beforeDestroy() {
        this.$nuxt.$off('evtUpsertNavigation');
        this.$nuxt.$off('evtDeleteNavigation');
    }
};
</script>