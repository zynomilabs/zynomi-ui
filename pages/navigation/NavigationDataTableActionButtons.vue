                                ...
                                <div>
                                    <span
                                        ...
                                        <span class="hidden lg:flex space-x-3">
                                            <button type="button"
                                                @click="$nuxt.$emit('evtRefreshNavigationDatatable')"
                                            ...
                                            <button type="button" @click="$nuxt.$emit('evtUpsertNavigation')"
                                                class="hidden sm:inline-flex -ml-px relative items-center px-4 py-2 rounded-md border border-gray-300 bg-white text-sm font-medium text-gray-900 hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1 focus:ring-blue-600 focus:border-blue-600">
                                                <!--<button type="button" @click="$nuxt.$emit('evtUpsertNavigation')" class="hidden sm:inline-flex -ml-px relative items-center px-4 py-2  border border-gray-300 bg-white text-sm font-medium text-gray-900 hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1 focus:ring-blue-600 focus:border-blue-600">-->
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                                    viewBox="0 0 20 20" fill="currentColor">
                                                    <path fill-rule="evenodd"
...
<script>
    /**
     * NavigationDataTableActionButtons.vue
     *
