<template>
    <div>
        <form name="frmSearchNavigation" id="frmSearchNavigation" ref="frmSearchNavigation" v-on:submit.prevent
            class="space-y-8 divide-y divide-gray-200">
            <div v-if="isFilterNavigationVisible" class="px-2 pt-2 border-b space-y-2">
                ...
                <div class="py-3 text-right">
                    ...
                    <button @click="searchNavigation()" type="submit"
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                isFilterNavigationVisible: false,
                mark_as_delete: "",
        }
    },
    methods: {
        searchNavigation() {
            ...
            $nuxt.$emit('evtSearchNavigation', args)
        },
    ...
    created() {
        this.$nuxt.$on('evtFilterNavigation', (data) => {
            this.isFilterNavigationVisible = !this.isFilterNavigationVisible;
        });
    },
};
</script>