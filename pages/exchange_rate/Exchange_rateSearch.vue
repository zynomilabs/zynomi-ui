<template>
    <div>
        <form name="frmSearchExchange_rate" id="frmSearchExchange_rate" ref="frmSearchExchange_rate" v-on:submit.prevent
            class="space-y-8 divide-y divide-gray-200">
            <div v-if="isFilterExchange_rateVisible" class="px-2 pt-2 border-b space-y-2">
                ...
                <div class="py-3 text-right">
                    ...
                    <button @click="searchExchange_rate()" type="submit"
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                isFilterExchange_rateVisible: false,
                mark_as_delete: "",
        }
    },
    methods: {
        searchExchange_rate() {
            ...
            $nuxt.$emit('evtSearchExchange_rate', args)
        },
    ...
    created() {
        this.$nuxt.$on('evtFilterExchange_rate', (data) => {
            this.isFilterExchange_rateVisible = !this.isFilterExchange_rateVisible;
        });
    },
};
</script>