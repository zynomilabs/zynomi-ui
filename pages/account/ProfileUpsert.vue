        ...
        <div class="sm:col-span-6">
          ...
          > Username </label>
            <div class="mt-1 flex rounded-md shadow-sm">
              <span class="inline-flex items-center px-3 rounded-l-md border border-r-0 border-blue-gray-300 bg-blue-gray-50 text-blue-gray-500 sm:text-sm"> zynomi.com/ </span>
              <input
                type="text"
                name="username"
                id="username"
