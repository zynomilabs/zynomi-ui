<template>
    <div>
        <form name="frmSearchPayment_type" id="frmSearchPayment_type" ref="frmSearchPayment_type" v-on:submit.prevent
            class="space-y-8 divide-y divide-gray-200">
            <div v-if="isFilterPayment_typeVisible" class="px-2 pt-2 border-b space-y-2">
                ...
                <div class="py-3 text-right">
                    ...
                    <button @click="searchPayment_type()" type="submit"
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                isFilterPayment_typeVisible: false,
                mark_as_delete: "",
        }
    },
    methods: {
        searchPayment_type() {
            ...
            $nuxt.$emit('evtSearchPayment_type', args)
        },
    ...
    created() {
        this.$nuxt.$on('evtFilterPayment_type', (data) => {
            this.isFilterPayment_typeVisible = !this.isFilterPayment_typeVisible;
        });
    },
};
</script>